<div id="primary" class="sidebar">
    ...
    <?php if (!dynamic_sidebar('sidebar-primary')) : ?>
        ...
        <aside id="archives" class="widget">
            ...
            <select id="archive-dropdown" name="m" onchange="applyArchiveFilter(this.value)" style="border: none;"> 
       ...
       <aside id="category" class="widget">
            ...
            <select id="category-dropdown" name="cat" onchange="window.location.href=this.value" style="border: none;">
                <?php
